...
*/
class LighttraceRenderer_RenderProcess final : public SamplingBasedRenderProcess
{
public:
...
RenderProcess* LighttraceRenderer::CreateRenderProcess(const Scene& scene, int threadID, int numThreads)
{
